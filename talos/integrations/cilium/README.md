...
echo "# This manifest was generated by automation. DO NOT EDIT." > talos/integrations/cilium/cilium-${CILIUM_VERSION}.yaml
kustomize build \
  --enable-helm \
  --load-restrictor=LoadRestrictionsNone \
 talos/integrations/cilium \
  >> talos/integrations/cilium/cilium-${CILIUM_VERSION}.yaml
```
