...
$language['create_account_tip2'] = 'Download and install the World of Warcraft ' . get_config('game_version') . ' client.';
...
$language['create_account_tip4'] = 'Open <strong>realmlist.wtf</strong> with a text editor, erase all text, and paste the following:';
