...
$language['create_account_tip2'] = 'Download and install the World of Warcraft ' . get_config('game_version') . ' client. You can download it from <a href="https://archive.org/details/World_of_Warcraft_Client_and_Installation_Archive" target="_blank">Internet Archive</a> (look for <strong>WoW-1.12.1_install.rar</strong>).';
$language['setup_game'] = 'Setup the game';
$language['create_account_tip3'] = 'Open your World of Warcraft installation folder and find the file <strong>realmlist.wtf</strong> (located inside the root directory or <code>Data/enUS</code> / <code>Data/enGB</code> depending on your client).';
$language['change_server_address'] = 'Change server address';
$language['create_account_tip4'] = 'Open <strong>realmlist.wtf</strong> with a text editor, erase all text, and set it to:';
